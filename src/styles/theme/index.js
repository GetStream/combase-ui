...
export const light = {
    ...
    color: {
        ...
        placeholder_shimmer: baseTheme.colorUtils.lighten(
            colors.light_gray,
            0.64
        ),
    },
...
export const dark = {
    ...
    color: {
        ...
        undersheet: baseTheme.colorUtils.fade(colors.black, 0.64),
        placeholder: baseTheme.colorUtils.darken(colors.black, 0.2),
        placeholder_shimmer: baseTheme.colorUtils.darken(colors.black, 0.1),
    },
};
